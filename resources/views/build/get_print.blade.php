...
@section('content')
    ...
    <div class="normal-content print-no-padding">
        ...
        <div class="ui breadcrumb print-hide">
            ...
            <div class="divider"> / </div>
            <a class="section" href="{{url('build/get/single?id=')}}{{$projectTeam->id}}" >施工收票查询 </a>
            <div class="divider"> / </div>
        ...
        <table class="ui celled center aligned table selectable unstackable">
            ...
            <tr>
                ...
                <th>已付款金额</th>
                <th class="fake-td">{{number_format($projectTeam->applies()->where('state','=',4)->sum('apply_price'),2)}} ￥</th>
            </tr>
            <tr>
