            ...
            <div class="ui three column doubling stackable grid">
                ...
                <div class="column">
                    <div class="inline fields">
                        ...
                        <div class="eleven wide field">
                            <el-autocomplete popper-class="my-autocomplete" v-model="buildFinishAdd.project_number" :fetch-suggestions="querySearchProjectId"
...
@endsection
@section('pageJs')
    <script src="{{url('js/build_finish_edit.js')}}"></script>
@endsection