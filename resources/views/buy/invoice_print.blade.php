...
@section('content')
    ...
    <div class="normal-content print-no-padding">
        ...
        <div class="ui breadcrumb print-hide">
            ...
            <div class="divider"> / </div>
            <a class="section" href="{{url('buy/list/invoice?id=')}}{{$purchase->id}}">采购收票查询 - {{$purchase->number}}</a>
            <div class="divider"> / </div>
        ...
        <table class="ui celled center aligned table selectable">
            ...
            <tr>
                ...
                <th class="font-normal bg-white" colspan="3">{{number_format($purchase->lists()->sum('cost')-$purchase->invoices()->sum('with_tax'),2)}} ￥</th>
            </tr>
            <tr>
