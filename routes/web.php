...
|
*/
Route::get('test','SystemController@fixData');
...
//   Route::get('budget/detail','ProjectController@showBudgetPage');
   ...
   Route::post('check/bail/edit','ProjectController@editBailInvoice');
    ...
    Route::get('del/check/tip','ProjectController@delCheckTip');
    ...
    Route::get('check/bail/tip/del','ProjectController@delCheckBailTip');
...
//    Route::get('pay/print','PayController@printPay');
    Route::post('add/pay/type','CostController@addPayType');
    ...
    Route::post('new/pay/add','CostController@addPay');
    Route::get('new/pay/list','CostController@listPayPage');
    Route::get('pay/types','CostController@searchPayTypes');
